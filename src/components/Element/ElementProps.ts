...
export interface StyleProps {
  ...
  /**
   * border-left
   * @returns border-left css property
   * @type string | object
   * @example
   * borderLeft='solid 1px black'
   * borderLeft={{ 0: 'solid 1px black', 768: 'solid 2px black' }}
   */
  borderLeft?: string | object

  /**
   * border-right
   * @returns border-right css property
   * @type string | object
   * @example
   * borderRight='solid 1px black'
   * borderRight={{ 0: 'solid 1px black', 768: 'solid 2px black' }}
   */
  borderRight?: string | object

  /**
   * border-top
   * @returns border-top css property
   * @type string | object
   * @example
   * borderTop='solid 1px black'
   * borderTop={{ 0: 'solid 1px black', 768: 'solid 2px black' }}
   */
  borderTop?: string | object

  /**
   * border-bottom
   * @returns border-bottom css property
   * @type string | object
   * @example
   * borderBottom='solid 1px black'
   * borderBottom={{ 0: 'solid 1px black', 768: 'solid 2px black' }}
   */
  borderBottom?: string | object
   ...
   * `}
   */
  css?: string | Record<string, unknown> | undefined
